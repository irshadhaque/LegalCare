...
//   return (
//     <section className="w- py-12 px-6 md:px-20 bg-gradient-to-r from-[#0f172a] to-[#1e1b4b] text-white rounded-xl shadow-lg">
//       <div className="w-full max-w-6xl rounded-xl shadow-lg p-6 md:p-10 flex flex-col md:flex-row items-center justify-between gap-10">
