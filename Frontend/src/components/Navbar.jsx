...
//   const location = useLocation(); // 👈 key part

//   useEffect(() => {
//     // Fetch user on initial mount and on location change
//     fetchProfile().then(setUser);
//   }, [location.pathname]); // 👈 re-checks user after route changes
...
//           />
//           <div className="absolute right-0 mt-2 w-56 p-4 bg-gray-800 border border-gray-700 rounded shadow-lg hidden group-hover:block z-50">
